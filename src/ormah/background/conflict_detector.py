        ...
        for candidate in candidates:
            ...
            with engine.db.transaction() as db_conn:
                if conflict_type == "evolution":
                    ...
                    # Tension conflicts are recorded as contradicts edges only.
                    # No observation node is created — Ormah fades into the background
                    # and does not demand user action for unresolved tensions.
