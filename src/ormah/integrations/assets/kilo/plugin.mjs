// Contract: @kilocode/plugin 7.7.9 Hooks['chat.message'].
...
function retrieve(payload) {
  return new Promise((resolve) => {
    const child = execFile(python, ['-m', 'ormah.integrations.kilo_bridge'], {
...
async function Ormah({ directory }) {
  return {
...
export default { id: "ormah", server: Ormah };
